...
export default function CategoriesPage({ categories }) {
  ...
  return (
    <section className="relative inset-0 h-full bg-blue-400">
      <SliderButton handleNext={handleNext} handlePrev={handlePrev} />
      <div className="relative pl-[45px] h-full w-full pb-[100px] my-[47px] bg-green-500 overflow-hidden">
        ...
        <ul
          className="flex column bg-orange-600 gap-5 snap-x snap-mandatory scroll-smooth pb-19 pt-2 pl-6 h-full select-none overflow-x-hidden scroll-ps-4 scroll-pe-3 "
        ...
        >
          {duplicatedCategories.map((category, index) => (
            ...
            >
              ...
              <div className="absolute text-center bottom-1/6 left-1/2 -translate-x-1/2 z-40 text-white">
